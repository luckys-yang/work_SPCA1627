...
set STR_LOG4=#define _svn_date_ "$WCDATE$"
set STR_LOG5=#define _svn_url_  "$WCURL$"
set STR_LOG6=#endif /* __VER_SVN_H__ */
...
if not exist %DIR_TAG%\.svn\ (
	echo The directory "%DIR_TAG%" is not controlled by SVN
	goto :EOF
)
