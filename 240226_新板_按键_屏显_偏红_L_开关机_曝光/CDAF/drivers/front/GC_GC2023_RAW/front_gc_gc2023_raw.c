 ...
 **************************************************************************/
/* device name. */
static code UINT8 frontDevName[] = "SENSOR - GC GC2023 RAW";
...
{
	gpioByteFuncSet(GPIO_BYTE_GEN1, (1 << ( 10 & 0x07)), (1 << ( 10 & 0x07)));  //gpio10 reset
	gpioByteDirSet(GPIO_BYTE_GEN1, (1 << ( 10 & 0x07)), (1 << ( 10 & 0x07)));
	gpioByteOutSet(GPIO_BYTE_GEN1, (1 << ( 10 & 0x07)), (1 << ( 10 & 0x07)));
	sp1kHalWait(20);
	
	gpioByteOutSet(GPIO_BYTE_GEN1, (1 << ( 10 & 0x07)), (0 << ( 10 & 0x07)));
	sp1kHalWait(100);
