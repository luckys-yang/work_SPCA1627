 ...
 **************************************************************************/
/**
 * @file		disp_tp_td025theea_ups052.c
 * @brief		display lcd toppoly td025theea driver
...
#define HSYNCW    1
#define VSYNCW    1
#define HPIXEL    390-2 /* 390-2 -> front in < display, 390-1 -> front in > display for mantis bug 41601 */
#define VLINE     265
#define PNLH0     59//56
#define PNLV0     21
...
#define CLK_DIVNX      21//17 /*75 fps*/ /* 21 for mantis bug 41601 */
#define CLK_DIV1X      4
 ...
 **************************************************************************/
/* device name. */
static code UINT8 dispDevName[] = "LCD - TP TD025THEEA UPS052";
