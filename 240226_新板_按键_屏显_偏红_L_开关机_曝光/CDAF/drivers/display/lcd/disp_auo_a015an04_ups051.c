 ...
 **************************************************************************/
/**
 * @file		disp_auo_a015an04_ups051.c
 * @brief		display lcd auo a015an04 driver with ups051 timing.
 * @author		Matt Wang
 * @since		2008-07-31
 * @date		2008-08-29
 */
 ...
 **************************************************************************/
/* device name. */
static code UINT8 dispDevName[] = "LCD - AUO A015AN04 UPS051";
...
)
{
	...
	/* set ups interface. */
	dispParaSet(DISP_PARA_UPS_COLOR_FILTER_CFG, DISP_UPS051_EVEN_RGB, DISP_UPS051_ODD_RGB, 0, 0, 0);
