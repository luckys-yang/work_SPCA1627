 ...
 **************************************************************************/
/**
 * @file		disp_ss_ltv160q1_ups052.c
 * @brief		display lcd samsung ltv160q1 driver
                with ups052 (serial rgb only mode) timing.
 * @author		Matt Wang
 * @since		2008-08-20
 * @date		2008-08-29
 */
...
#define CLK_DIVNX      9/3
#define CLK_DIV1X      1*3
 ...
 **************************************************************************/
/* device name. */
static code UINT8 dispDevName[] = "LCD - SS LTV160Q1 UPS052";
