 ...
 **************************************************************************/
/**
 * @file		disp_gp_gpg12129qs1_lcm.c
 * @brief		display lcm giant plus gpg12129qs1 driver.
 * @author		Matt Wang
 * @since		2008-08-06
 * @date		2008-10-03
 */
 ...
 **************************************************************************/
/* device name. */
static code UINT8 dispDevName[] = "LCD - GP GPG12129QS1 LCM";
...
static code UINT32 dispPwrOnCmdTbl[] = {
	...
	DISP_LCM_CMD_INST | 0xF8,  /* undocument? */
	DISP_LCM_CMD_PARA | 0x54,
	DISP_LCM_CMD_PARA | 0x12,
	DISP_LCM_CMD_INST | 0xF9,  /* undocument? */
	...
	DISP_LCM_CMD_PARA | (LCM_X_ADJ >> 8),
	DISP_LCM_CMD_PARA | (LCM_X_ADJ & 0xFF),
	DISP_LCM_CMD_PARA | ((WIDTH - 1 + LCM_X_ADJ) >> 8),
	DISP_LCM_CMD_PARA | ((WIDTH - 1 + LCM_X_ADJ) & 0xFF),
	DISP_LCM_CMD_INST | 0x2B,  /* raset. */
	DISP_LCM_CMD_PARA | (LCM_Y_ADJ >> 8),
	DISP_LCM_CMD_PARA | (LCM_Y_ADJ & 0xFF),
	DISP_LCM_CMD_PARA | ((HEIGHT - 1 + LCM_Y_ADJ) >> 8),
	DISP_LCM_CMD_PARA | ((HEIGHT - 1 + LCM_Y_ADJ) & 0xFF),
