...
*/
	...
	//DCDC_SEL              
	DISP_LCM_CMD_INST | 0xBB,  	
	DISP_LCM_CMD_PARA | 0x4a,//0x46  	
	DISP_LCM_CMD_PARA | 0x79,//0x7A
	DISP_LCM_CMD_PARA | 0x40,  	
	DISP_LCM_CMD_PARA | 0x40,  	
	DISP_LCM_CMD_PARA | 0x70,  	
	...
	DISP_LCM_CMD_PARA | 0x37, //0x38
	DISP_LCM_CMD_PARA | 0x32, //0x32
	DISP_LCM_CMD_PARA | 0x2F, //0x30
	DISP_LCM_CMD_PARA | 0x30, //0x31
	DISP_LCM_CMD_PARA | 0x36, //0x39
	DISP_LCM_CMD_PARA | 0x31, //0x35
	DISP_LCM_CMD_PARA | 0x30, //0x34
	DISP_LCM_CMD_PARA | 0x2E, //0x32
	DISP_LCM_CMD_PARA | 0x2D, //0x31
	DISP_LCM_CMD_PARA | 0x27, //0x2C
	DISP_LCM_CMD_PARA | 0x17, //0x1E
	DISP_LCM_CMD_PARA | 0x11, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	DISP_LCM_CMD_PARA | 0x02, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x37, //0x36
	DISP_LCM_CMD_PARA | 0x31, //0x33
	DISP_LCM_CMD_PARA | 0x2F, //0x2F
	DISP_LCM_CMD_PARA | 0x2F, //0x30
	DISP_LCM_CMD_PARA | 0x36, //0x38
	DISP_LCM_CMD_PARA | 0x31, //0x34
	DISP_LCM_CMD_PARA | 0x30, //0x33
	DISP_LCM_CMD_PARA | 0x2E, //0x32
	DISP_LCM_CMD_PARA | 0x2C, //0x30
	DISP_LCM_CMD_PARA | 0x27, //0x2C
	DISP_LCM_CMD_PARA | 0x17, //0x1E
	DISP_LCM_CMD_PARA | 0x11, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	...
	DISP_LCM_CMD_INST | 0xC8, //G2.2	
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x23, //0x38
	DISP_LCM_CMD_PARA | 0x18, //0x32
	DISP_LCM_CMD_PARA | 0x18, //0x30
	DISP_LCM_CMD_PARA | 0x1A, //0x31
	DISP_LCM_CMD_PARA | 0x1D, //0x39
	DISP_LCM_CMD_PARA | 0x19, //0x35
	DISP_LCM_CMD_PARA | 0x1A, //0x34
	DISP_LCM_CMD_PARA | 0x19, //0x32
	DISP_LCM_CMD_PARA | 0x19, //0x31
	DISP_LCM_CMD_PARA | 0x16, //0x2C
	DISP_LCM_CMD_PARA | 0x08, //0x1E
	DISP_LCM_CMD_PARA | 0x05, //0x19
	DISP_LCM_CMD_PARA | 0x02, //0x10
	DISP_LCM_CMD_PARA | 0x02, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x23, //0x36
	DISP_LCM_CMD_PARA | 0x18, //0x33
	DISP_LCM_CMD_PARA | 0x18, //0x2F
	DISP_LCM_CMD_PARA | 0x1A, //0x30
	DISP_LCM_CMD_PARA | 0x1D, //0x38
	DISP_LCM_CMD_PARA | 0x19, //0x34
	DISP_LCM_CMD_PARA | 0x1A, //0x33
	DISP_LCM_CMD_PARA | 0x19, //0x32
	DISP_LCM_CMD_PARA | 0x19, //0x30
	DISP_LCM_CMD_PARA | 0x18, //0x2C
	DISP_LCM_CMD_PARA | 0x08, //0x1E
	DISP_LCM_CMD_PARA | 0x05, //0x19
	DISP_LCM_CMD_PARA | 0x02, //0x10
	DISP_LCM_CMD_PARA | 0x02, //0x0A
	...
	DISP_LCM_CMD_INST | 0xC8, //G2.2	
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x24, //0x38
	DISP_LCM_CMD_PARA | 0x19, //0x32
	DISP_LCM_CMD_PARA | 0x19, //0x30
	DISP_LCM_CMD_PARA | 0x1C, //0x31
	DISP_LCM_CMD_PARA | 0x1F, //0x39
	DISP_LCM_CMD_PARA | 0x1B, //0x35
	DISP_LCM_CMD_PARA | 0x1C, //0x34
	DISP_LCM_CMD_PARA | 0x1B, //0x32
	DISP_LCM_CMD_PARA | 0x1B, //0x31
	DISP_LCM_CMD_PARA | 0x19, //0x2C
	DISP_LCM_CMD_PARA | 0x0B, //0x1E
	DISP_LCM_CMD_PARA | 0x09, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	DISP_LCM_CMD_PARA | 0x02, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x24, //0x36
	DISP_LCM_CMD_PARA | 0x19, //0x33
	DISP_LCM_CMD_PARA | 0x19, //0x2F
	DISP_LCM_CMD_PARA | 0x1C, //0x30
	DISP_LCM_CMD_PARA | 0x1F, //0x38
	DISP_LCM_CMD_PARA | 0x1B, //0x34
	DISP_LCM_CMD_PARA | 0x1C, //0x33
	DISP_LCM_CMD_PARA | 0x1B, //0x32
	DISP_LCM_CMD_PARA | 0x1B, //0x30
	DISP_LCM_CMD_PARA | 0x19, //0x2C
	DISP_LCM_CMD_PARA | 0x0B, //0x1E
	DISP_LCM_CMD_PARA | 0x09, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	...
	DISP_LCM_CMD_INST | 0xC8, //G2.2	
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x25, //0x38
	DISP_LCM_CMD_PARA | 0x1C, //0x32
	DISP_LCM_CMD_PARA | 0x1C, //0x30
	DISP_LCM_CMD_PARA | 0x1F, //0x31
	DISP_LCM_CMD_PARA | 0x23, //0x39
	DISP_LCM_CMD_PARA | 0x1F, //0x35
	DISP_LCM_CMD_PARA | 0x1F, //0x34
	DISP_LCM_CMD_PARA | 0x1E, //0x32
	DISP_LCM_CMD_PARA | 0x1E, //0x31
	DISP_LCM_CMD_PARA | 0x1D, //0x2C
	DISP_LCM_CMD_PARA | 0x13, //0x1E
	DISP_LCM_CMD_PARA | 0x0F, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	DISP_LCM_CMD_PARA | 0x06, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x25, //0x36
	DISP_LCM_CMD_PARA | 0x1C, //0x33
	DISP_LCM_CMD_PARA | 0x1C, //0x2F
	DISP_LCM_CMD_PARA | 0x1F, //0x30
	DISP_LCM_CMD_PARA | 0x23, //0x38
	DISP_LCM_CMD_PARA | 0x1F, //0x34
	DISP_LCM_CMD_PARA | 0x1F, //0x33
	DISP_LCM_CMD_PARA | 0x1E, //0x32
	DISP_LCM_CMD_PARA | 0x1E, //0x30
	DISP_LCM_CMD_PARA | 0x1D, //0x2C
	DISP_LCM_CMD_PARA | 0x13, //0x1E
	DISP_LCM_CMD_PARA | 0x0F, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	...
	DISP_LCM_CMD_PARA | 0x1B, //0x30
	DISP_LCM_CMD_PARA | 0x1E, //0x31
	DISP_LCM_CMD_PARA | 0x21, //0x39
	DISP_LCM_CMD_PARA | 0x1D, //0x35
	DISP_LCM_CMD_PARA | 0x1E, //0x34
	DISP_LCM_CMD_PARA | 0x1D, //0x32
	DISP_LCM_CMD_PARA | 0x1D, //0x31
	DISP_LCM_CMD_PARA | 0x1B, //0x2C
	DISP_LCM_CMD_PARA | 0x11, //0x1E
	DISP_LCM_CMD_PARA | 0x0F, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	DISP_LCM_CMD_PARA | 0x06, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	...
	DISP_LCM_CMD_PARA | 0x25, //0x36
	DISP_LCM_CMD_PARA | 0x1C, //0x33
	DISP_LCM_CMD_PARA | 0x1B, //0x2F
	DISP_LCM_CMD_PARA | 0x1E, //0x30
	DISP_LCM_CMD_PARA | 0x21, //0x38
	DISP_LCM_CMD_PARA | 0x1D, //0x34
	DISP_LCM_CMD_PARA | 0x1E, //0x33
	DISP_LCM_CMD_PARA | 0x1D, //0x32
	DISP_LCM_CMD_PARA | 0x1D, //0x30
	DISP_LCM_CMD_PARA | 0x1B, //0x2C
	DISP_LCM_CMD_PARA | 0x11, //0x1E
	DISP_LCM_CMD_PARA | 0x0F, //0x19
	DISP_LCM_CMD_PARA | 0x08, //0x10
	...
	DISP_LCM_CMD_PARA | 0x1A, //0x30
	DISP_LCM_CMD_PARA | 0x1D, //0x31
	DISP_LCM_CMD_PARA | 0x20, //0x39
	DISP_LCM_CMD_PARA | 0x1C, //0x35
	DISP_LCM_CMD_PARA | 0x1D, //0x34
	DISP_LCM_CMD_PARA | 0x1C, //0x32
	DISP_LCM_CMD_PARA | 0x1C, //0x31
	DISP_LCM_CMD_PARA | 0x1B, //0x2C
	...
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x24, //0x36
	DISP_LCM_CMD_PARA | 0x1B, //0x33
	DISP_LCM_CMD_PARA | 0x1A, //0x2F
	DISP_LCM_CMD_PARA | 0x1D, //0x30
	DISP_LCM_CMD_PARA | 0x20, //0x38
	DISP_LCM_CMD_PARA | 0x1C, //0x34
	DISP_LCM_CMD_PARA | 0x1D, //0x33
	DISP_LCM_CMD_PARA | 0x1C, //0x32
	DISP_LCM_CMD_PARA | 0x1C, //0x30
	DISP_LCM_CMD_PARA | 0x1B, //0x2C
	DISP_LCM_CMD_PARA | 0x11, //0x1E
	...
	DISP_LCM_CMD_PARA | 0x1D, //0x32
	DISP_LCM_CMD_PARA | 0x1D, //0x30
	DISP_LCM_CMD_PARA | 0x21, //0x31
	DISP_LCM_CMD_PARA | 0x25, //0x39
	DISP_LCM_CMD_PARA | 0x21, //0x35
	DISP_LCM_CMD_PARA | 0x22, //0x34
	DISP_LCM_CMD_PARA | 0x21, //0x32
	DISP_LCM_CMD_PARA | 0x21, //0x31
	DISP_LCM_CMD_PARA | 0x1F, //0x2C
	DISP_LCM_CMD_PARA | 0x17, //0x1E
	DISP_LCM_CMD_PARA | 0x13, //0x19
	DISP_LCM_CMD_PARA | 0x0C, //0x10
	DISP_LCM_CMD_PARA | 0x0E, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x25, //0x36
	DISP_LCM_CMD_PARA | 0x1D, //0x33
	DISP_LCM_CMD_PARA | 0x1D, //0x2F
	DISP_LCM_CMD_PARA | 0x21, //0x30
	DISP_LCM_CMD_PARA | 0x25, //0x38
	DISP_LCM_CMD_PARA | 0x21, //0x34
	DISP_LCM_CMD_PARA | 0x21, //0x33
	DISP_LCM_CMD_PARA | 0x20, //0x32
	DISP_LCM_CMD_PARA | 0x21, //0x30
	DISP_LCM_CMD_PARA | 0x1F, //0x2C
	DISP_LCM_CMD_PARA | 0x17, //0x1E
	DISP_LCM_CMD_PARA | 0x13, //0x19
	...
	DISP_LCM_CMD_INST | 0xC8, //G2.2	
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x28, //0x38
	DISP_LCM_CMD_PARA | 0x1E, //0x32
	DISP_LCM_CMD_PARA | 0x1F, //0x30
	DISP_LCM_CMD_PARA | 0x23, //0x31
	DISP_LCM_CMD_PARA | 0x27, //0x39
	DISP_LCM_CMD_PARA | 0x24, //0x35
	DISP_LCM_CMD_PARA | 0x24, //0x34
	DISP_LCM_CMD_PARA | 0x24, //0x32
	DISP_LCM_CMD_PARA | 0x24, //0x31
	DISP_LCM_CMD_PARA | 0x23, //0x2C
	DISP_LCM_CMD_PARA | 0x1C, //0x1E
	DISP_LCM_CMD_PARA | 0x1B, //0x19
	DISP_LCM_CMD_PARA | 0x13, //0x10
	DISP_LCM_CMD_PARA | 0x0E, //0x0A
	DISP_LCM_CMD_PARA | 0x04, //0x04
	DISP_LCM_CMD_PARA | 0x3F, //0x3F   	
	DISP_LCM_CMD_PARA | 0x28, //0x36
	DISP_LCM_CMD_PARA | 0x1E, //0x33
	DISP_LCM_CMD_PARA | 0x1F, //0x2F
	DISP_LCM_CMD_PARA | 0x23, //0x30
	DISP_LCM_CMD_PARA | 0x27, //0x38
	DISP_LCM_CMD_PARA | 0x24, //0x34
	DISP_LCM_CMD_PARA | 0x24, //0x33
	DISP_LCM_CMD_PARA | 0x24, //0x32
	DISP_LCM_CMD_PARA | 0x24, //0x30
	DISP_LCM_CMD_PARA | 0x23, //0x2C
	DISP_LCM_CMD_PARA | 0x1C, //0x1E
	DISP_LCM_CMD_PARA | 0x1B, //0x19
	DISP_LCM_CMD_PARA | 0x13, //0x10
