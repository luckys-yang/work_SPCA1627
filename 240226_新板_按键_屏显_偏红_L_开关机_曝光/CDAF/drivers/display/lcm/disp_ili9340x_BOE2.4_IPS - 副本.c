...
static code UINT32 dispPwrOnCmdTbl[] = {
	...
	DISP_LCM_CMD_INST | 0xBA,    
	DISP_LCM_CMD_PARA | 0x1f,//0x22  
	DISP_LCM_CMD_PARA | 0x11,//0x0B
	DISP_LCM_CMD_PARA | 0x20,

	DISP_LCM_CMD_INST | 0xBB,    
	DISP_LCM_CMD_PARA | 0x74,//0x44,  
	DISP_LCM_CMD_PARA | 0x77,//0x66,
