 ...
 **************************************************************************/
/**
 * @file		disp_txd_txdc190c1_lcm.c
 * @brief		display lcm tongxingda txdc190c-1 driver.
 * @author		Meirong Liu, Matt Wang
 * @since		2008-08-18
 * @date		2008-08-19
 */
...
#define PULSE_ACT       1+2
#define PULSE_RCV       2+2
#define CS0_ACT         0
#define A0_CMD          0
 ...
 **************************************************************************/
/* device name. */
static code UINT8 dispDevName[] = "LCD - TXD TXDC190C1 LCM";
...
static code UINT32 dispPwrOnCmdTbl[] = {
	DISP_LCM_CMD_INST | 0xE2,  /* set system reset. */
	DISP_LCM_CMD_WAIT | 500,
	DISP_LCM_CMD_INST | 0xA8,  /* set display enable. */
	DISP_LCM_CMD_INST | 0xEB,  /* set lcd bias ratio. */
	DISP_LCM_CMD_INST | 0x24,  /* set temperature compensation. */
	DISP_LCM_CMD_INST | 0x81,  /* set vbias potentiometer. */
	DISP_LCM_CMD_INST | 0x74,
	DISP_LCM_CMD_INST | 0xA3,  /* set line rate. */
	DISP_LCM_CMD_INST | 0xC8,  /* set n-line inversion. */
	DISP_LCM_CMD_INST | 0x11,
	DISP_LCM_CMD_INST | 0xDE,  /* set com scan function. */
	DISP_LCM_CMD_INST | 0xD0,  /* set color pattern. */
	DISP_LCM_CMD_INST | 0xD6,  /* set color mode. */
	DISP_LCM_CMD_INST | 0x31,  /* set adv. program control. */
	DISP_LCM_CMD_INST | 0x08,
	DISP_LCM_CMD_INST | 0x30,  /* set adv. program control. */
	DISP_LCM_CMD_INST | 0x5F,
	DISP_LCM_CMD_INST | 0x84,  /* set partial display control. */
	DISP_LCM_CMD_INST | 0x2A,  /* set power control. */
	DISP_LCM_CMD_INST | 0x2F,  /* undocument? */
	DISP_LCM_CMD_INST | 0x8B,  /* set ram address control. */
	DISP_LCM_CMD_INST | 0xC4,  /* set lcd mapping control. */
	DISP_LCM_CMD_INST | 0xF8,  /* set window program mode. */
	DISP_LCM_CMD_INST | 0xAF,  /* set display enable. */
