...
static code UINT32 dispPwrOnCmdTbl[] = {
	...
	DISP_LCM_CMD_PARA | 0x7f,//0x0E,
	DISP_LCM_CMD_PARA | 0x7f,//0x0A,
	...
	#if 1
	//Set_R_GAMMA2.5      
	DISP_LCM_CMD_INST | 0xC8,  //G2.0	 //G1.8    //2.5
	DISP_LCM_CMD_PARA | 0x3F,  //0x3F   //0x3F	   //0x3F
	DISP_LCM_CMD_PARA | 0x2E,  //0x2F   //0x2F    //0x2B
	DISP_LCM_CMD_PARA | 0x24,  //0x25   //0x27    //0x25
	DISP_LCM_CMD_PARA | 0x24,  //0x25   //0x28    //0x22
	DISP_LCM_CMD_PARA | 0x27,  //0x29   //0x2B    //0x24
	DISP_LCM_CMD_PARA | 0x2A,  //0x2C   //0x2E    //0x26
	DISP_LCM_CMD_PARA | 0x25,  //0x28   //0x2A    //0x21
	DISP_LCM_CMD_PARA | 0x25,  //0x28   //0x2A    //0x22
	DISP_LCM_CMD_PARA | 0x24,  //0x27   //0x29    //0x20
	DISP_LCM_CMD_PARA | 0x23,  //0x26   //0x29    //0x1F
	DISP_LCM_CMD_PARA | 0x21,  //0x24   //0x28    //0x1C
	DISP_LCM_CMD_PARA | 0x17,  //0x1B   //0x1F    //0x0F
	DISP_LCM_CMD_PARA | 0x13,  //0x18   //0x1E    //0x0D
	DISP_LCM_CMD_PARA | 0x0C,  //0x12   //0x19    //0x08
	DISP_LCM_CMD_PARA | 0x08,  //0x0D   //0x12    //0x03
	DISP_LCM_CMD_PARA | 0x04,  //0x04   //0x04    //0x04
	DISP_LCM_CMD_PARA | 0x3F,  //0x3F   //0x3F	   //0x3F
	DISP_LCM_CMD_PARA | 0x2E,  //0x2F   //0x2F    //0x2B
	DISP_LCM_CMD_PARA | 0x24,  //0x25   //0x27    //0x25
	DISP_LCM_CMD_PARA | 0x24,  //0x25   //0x28    //0x22
	...
	DISP_LCM_CMD_PARA | 0x20,    //2 lane SPI
	DISP_LCM_CMD_PARA | 0x00,  
