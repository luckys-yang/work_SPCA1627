...
static code UINT32 dispPwrOnCmdTbl[] = {
	...
	DISP_LCM_CMD_PARA | 0x00,
	DISP_LCM_CMD_PARA | 0x1c, // 0x1b default // 0x1c te
	...
	DISP_LCM_CMD_PARA | 0x21, // 0x21, // 0x1B,   	// VRH[5:0] 

	DISP_LCM_CMD_INST | 0xC1,   	// Power control 
	DISP_LCM_CMD_PARA | 0x13, // 0x12,   	// SAP[2:0];BT[3:0] 
 
	DISP_LCM_CMD_INST | 0xC5,    	// VCM control 
	DISP_LCM_CMD_PARA | 0x48, // 0x48, // 0x25,	// 0x35 
	DISP_LCM_CMD_PARA | 0x48, // 0x48, // 0x2E,	// 0x3E 
  
	DISP_LCM_CMD_INST | 0xC7,    	// VCM control2 
	DISP_LCM_CMD_PARA | 0xa1, // 0xa2, // 0xb7, // 0x88,
	...
	DISP_LCM_CMD_PARA | 0x2b, // 0x1D,
	DISP_LCM_CMD_PARA | 0x28, // 0x1A, 
	DISP_LCM_CMD_PARA | 0x0d, 
	DISP_LCM_CMD_PARA | 0x0f, 
	DISP_LCM_CMD_PARA | 0x08, // 0x07, 
	DISP_LCM_CMD_PARA | 0x49, // 0x49, 
	DISP_LCM_CMD_PARA | 0x98, // 0X66, 
	DISP_LCM_CMD_PARA | 0x31, // 0x3B, 
	DISP_LCM_CMD_PARA | 0x07, // 0x07, 
	DISP_LCM_CMD_PARA | 0x0f, // 0x11, 
	DISP_LCM_CMD_PARA | 0x02, // 0x01, 
	DISP_LCM_CMD_PARA | 0x0d, // 0x09, 
	DISP_LCM_CMD_PARA | 0x09, // 0x05, 
	DISP_LCM_CMD_PARA | 0x00, // 0x04, 
                  
	DISP_LCM_CMD_INST | 0XE1,    	// Set Gamma 
	DISP_LCM_CMD_PARA | 0x00,
	DISP_LCM_CMD_PARA | 0x0c, // 0x18, 
	DISP_LCM_CMD_PARA | 0x0f, // 0x1D, 
	DISP_LCM_CMD_PARA | 0x04, // 0x02, 
	DISP_LCM_CMD_PARA | 0x11, // 0x0F, 
	DISP_LCM_CMD_PARA | 0x07, // 0x04, 
	DISP_LCM_CMD_PARA | 0x36, // 0x36, 
	DISP_LCM_CMD_PARA | 0x67,
	DISP_LCM_CMD_PARA | 0x4f, // 0x4C, 
	DISP_LCM_CMD_PARA | 0x07, // 0x07, 
	DISP_LCM_CMD_PARA | 0x0f, // 0x13, 
	DISP_LCM_CMD_PARA | 0x0c, // 0x0F, 
	DISP_LCM_CMD_PARA | 0x36, // 0x2E, 
	DISP_LCM_CMD_PARA | 0x39, // 0x2F, 
