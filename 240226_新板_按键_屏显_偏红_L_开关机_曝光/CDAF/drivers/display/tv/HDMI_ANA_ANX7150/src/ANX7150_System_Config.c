...
void ANX7150_API_System_Config()
{
    ...
    ANX7150_API_AUD_CHStatus_Config(null,null,null,null,null,null,null,null,null,ANX7150_AUD_CLK_SAMPLE_RATE);
#endif
}
...
{
    BYTE video_id;
    i2c_read_p1_reg(0xa7, &video_id); //jack wen
