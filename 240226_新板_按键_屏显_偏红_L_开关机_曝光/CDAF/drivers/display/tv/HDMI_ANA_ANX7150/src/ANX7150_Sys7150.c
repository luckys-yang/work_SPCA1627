...
/*#ifdef ITU656*/
/*code
*/ struct ANX7150_video_timingtype code ANX7150_video_timingtype_table = 
{
     //640x480p-60hz
...
/*#endif */
/*code*/  struct Bist_Video_Format code bist_demo[] = { 
...
void ANX7150_Variable_Initial() 
{
    ...
    //********************for edid parse***********
    ANX7150_edid_result.is_HDMI = 1;/* stanley*/
    ...
    BYTE c;
		if (1/*!BIST_EN*/ ) 
		{
			...
			c = (c<<1) | 0;/*stanley P2_6;*/
				...
				{
					case 0:
						ANX7150_video_format_config = 0x03;//jack wen, yc mux, 601, 15-8,3-0
						//HDMI_RX_VID_Output_Fmt(YCbCr422_YCMUX); //jack wen, yc mux 601
						break;
					case 1:
						ANX7150_video_format_config = 0x05;//jack wen, yc mux, 656, 15-8,3-0
						//HDMI_RX_VID_Output_Fmt(YCbCr422_656_YCMUX); //jack wen, yc mux 656
						break;
					case 2:
						ANX7150_video_format_config = 0x07;//jack wen, DDR yc422, 601, 
						/*
						HDMI_RX_VID_Output_Fmt(YCbCr422_YCMUX); //jack wen, DDR yc422 601
						//HDMI_RX_AVC_Off();
					    ...
					    */
						break;
					case 3:
						ANX7150_video_format_config = 0x08;//jack wen, DDR yc422, 656, 
						/*
						HDMI_RX_VID_Output_Fmt(YCbCr422_656_YCMUX); //jack wen, DDR yc422 656
						//HDMI_RX_AVC_Off();
						HDMI_RX_ReadI2C_RX0(HDMI_RX_AVC_EXCEPTION_MASK2_REG, &c);
					    HDMI_RX_WriteI2C_RX0(HDMI_RX_AVC_EXCEPTION_MASK2_REG, ((c & 0xbf) | 0x40));
						HDMI_RX_ReadI2C_RX0(HDMI_RX_SYS_CTRL1_REG, &c);
...
void ANX7150_Config_Video()
{
   ...
   ANX7150_i2c_read_p0_reg(ANX7150_INTR2_MASK_REG, &c);
    ...
    ANX7150_i2c_read_p0_reg(ANX7150_TMDS_CLKCH_CONFIG_REG, &c);
    ANX7150_i2c_write_p0_reg(ANX7150_TMDS_CLKCH_CONFIG_REG, (c | ANX7150_TMDS_CLKCH_MUTE));
    delay_ms(100);  //delay_ms(10); //wen HDCP CTS
...
{
    BYTE c;
	BYTE Bksv_valid=0;//wen HDCP CTS
...
void ANX7150_Hardware_HDCP_Auth_Init(void) 
{
    ...
    #endif
    /*end*/
    ANX7150_i2c_write_p0_reg(ANX7150_HDCP_CTRL0_REG, 0x00);  //simon 20071226//wen HDCP CTS
    // disable hdcp
    ANX7150_i2c_read_p0_reg(ANX7150_HDCP_CTRL0_REG, &c);
    ANX7150_i2c_write_p0_reg(ANX7150_HDCP_CTRL0_REG, (c & (~ANX7150_HDCP_CTRL0_HW_AUTHEN)));
