 ...
 **************************************************************************/
/**
 * @file		disp_composite_tv_pal.c
 * @brief		display composite tv driver with pal timing.
 * @author		Matt Wang
 * @since		2008-06-03
 * @date		2009-01-21
 */
...
/* render dimension. */
#define DEV_TYPE  DISP_DEVICE_TYPE_COMPOSITE_PAL
#define WIDTH     720
#define HEIGHT    576
#define HSYNCW    3//5
#define VSYNCW    64//5
#define HPIXEL    864//858
#define VLINE     625
#define PNLH0     126//121
#define PNLV0     39
...
#define OSDH0     PNLH0+42
#define OSDV0     PNLV0 +20+32
#define OSDH1     PNLH1 - 52 
#define OSDV1     PNLV1-74+32
...
/* operating function. */
#define dispOpDevNameGet     dispPalOpDevNameGet
#define dispOpCapabilityGet  dispPalOpCapabilityGet
#define dispOpPowerOn        dispPalOpPowerOn
#define dispOpPowerOff       dispPalOpPowerOff
...
*******************************************************************************/
/* device name. */
static code UINT8 dispDevName[] = "TV - COMPOSITE PAL";
...
{
	SINT16 mtxA[9] = {0x0026,0x004b,0x000e,0x07ef,0x07db,0x0038,0x0050,0x07be,0x07f3};
	SINT16 mtxB[3] = {0x00};
	//--------------------------
